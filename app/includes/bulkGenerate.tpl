<main class="tab-pane active" ng-if="globalService.currentTab==globalService.tabs.bulkGenerate.id"
      ng-controller="bulkGenCtrl" ng-cloak>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="alert alert-danger" translate="ERROR_28">**You need your Keystore File + password or Private
                    ...
                    recover a wallet if you do not save it. Read the [help page](https://www.myetherwallet.com/#help)
                    for instructions.
                </div>
            </div>
            ...
            <article class="col-md-9">
                <table id="bulkgentable" class="table">
                    ...
                    <tr class="privaddkey" ng-repeat="wallet in wallets">
                        <td>
                            <div class="addressIdenticon" title="Address Indenticon"
                                 blockie-address="{{wallet.getAddressString()}}" watch-var="wallet"></div>
                        </td>
                        <td>
                            <label>
                                <textarea class="form-control" rows="4"
                                          readonly>{{wallet.getChecksumAddressString()}}</textarea>
                            </label>
                        </td>
                        <td>
                            <label>
                                <textarea class="form-control" rows="4"
                                          readonly>{{wallet.getPrivateKeyString()}}</textarea>
                            </label>
                        </td>
                    </tr>
                    </thead>
            ...
            <article class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-info btn-block" href="{{bJSON}}" download="bulk_ether_accounts.json"
                       translate="x_Download">DOWNLOAD</a>
                </div>
                <div class="form-group">
                    <label translate="x_CSV"> CSV file (unencrypted)</label>
                    <a class="btn btn-info btn-block" href="{{bCSV}}" download="bulk_ether_accounts.csv"
                       translate="x_Download">DOWNLOAD</a>
                </div>
                <div class="form-group">
                    <label translate="x_TXT"> TXT file (unencrypted)</label>
                    <a class="btn btn-info btn-block" href="{{bTXT}}" download="bulk_ether_accounts.txt"
                       translate="x_Download">DOWNLOAD</a>
                </div>
            </article>
