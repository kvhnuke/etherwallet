...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <a href="@@siteurl"><img src="images/@@sitelogo" height="45px" width="auto" alt="@@sitename" class="footer--logo"/></a>
...
@@if (!custom || showExtensions) {
      ...
      <p>
@@if (instagram) {
        <a href="@@instagram" aria-label="instagram" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
...
@@if (reddit) {
        <a aria-label="reddit" href="@@reddit" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
...
@@if (twitter) {
        <a aria-label="twitter" title="twitter" href="@@twitter" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
...
@@if (facebook) {
        <a aria-label="facebook" title="facebook" href="@@facebook" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
...
@@if (medium) {
        <a aria-label="medium" title="medium" href="@@medium" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
...
@@if (linkedin) {
        <a aria-label="linkedin" title="linkedin" href="@@linkedin" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
...
@@if (github) {
        <a aria-label="github" title="github" href="@@github" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
...
@@if (support) {
        <a aria-label="support email" title="support email" href="@@support" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
...
@@if (site === 'mew' || site === 'cx') { @@include( './footer-disclaimer-modal.tpl', { "site": "@@site" } ) }

@@if (site === 'mew' || site === 'cx') { @@include( './onboardingModal.tpl', { "site": "@@site" } ) }
